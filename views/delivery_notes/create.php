<?php
$pageTitle   = 'Nouveau bon de livraison — ' . APP_NAME;
$breadcrumbs = ['Bons de livraison' => 'delivery-notes', 'Nouveau bon' => ''];
...
<div class="d-flex align-items-center gap-2 mb-4">
  <a href="<?= APP_URL ?>/delivery-notes" class="btn btn-sm btn-outline-secondary">
    <i class="bi bi-arrow-left"></i>
  </a>
  <h4 class="fw-bold mb-0"><i class="bi bi-truck me-2 text-primary"></i>Nouveau bon de livraison</h4>
</div>
...
<form method="POST" action="<?= APP_URL ?>/delivery-notes/store" novalidate>
  <div class="row g-3">
          ...
          <div class="row g-3">
            <div class="col-md-2">
              ...
              <input type="text" name="note_number" class="form-control" required
                     value="<?= e($old['note_number'] ?? $nextNum) ?>">
            </div>
            <div class="col-md-2">
            ...
            <table class="table align-middle mb-0">
              <thead class="table-light">
                <tr>
                  ...
                  <th style="width:20%" id="priceHeader">Prix unit. (optionnel)</th>
                  <th style="width:5%"></th>
                </tr>
              </thead>
    ...
    <div class="col-12 d-flex justify-content-end gap-2">
      <a href="<?= APP_URL ?>/delivery-notes" class="btn btn-outline-secondary">Annuler</a>
