<?php
$pageTitle   = 'Modifier devis — ' . APP_NAME;
$breadcrumbs = ['Devis' => 'devis', 'Modifier' => ''];
require __DIR__ . '/../layout/header.php';

$devisId = (int) ($old['id'] ?? $_GET['id'] ?? 0);
...
<div class="d-flex align-items-center gap-2 mb-4">
  <a href="<?= APP_URL ?>/devis/show?id=<?= $devisId ?>" class="btn btn-sm btn-outline-secondary">
    <i class="bi bi-arrow-left"></i>
  </a>
  <h4 class="fw-bold mb-0">Modifier le devis</h4>
</div>
...
<form method="POST" action="<?= APP_URL ?>/devis/update" id="devisForm" novalidate>
  ...
  <div class="row g-3">
    ...
    <div class="col-12 d-flex justify-content-end gap-2">
      <a href="<?= APP_URL ?>/devis/show?id=<?= $devisId ?>" class="btn btn-outline-secondary">Annuler</a>
