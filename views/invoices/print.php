...
<head>
  ...
  <style>
    ...
    *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .doc-ref  { font-size: 13px; font-weight: 600; margin-top: 6px; color: #111; }
...
<div class="page">
  ...
  <div class="action-bar no-print">
    ...
    <a class="btn-pdf" href="<?= APP_URL ?>/invoices/pdf?id=<?= $invoice['id'] ?>">Télécharger PDF</a>
    <a class="btn-back" href="<?= APP_URL ?>/invoices/show?id=<?= $invoice['id'] ?>">← Retour</a>
  </div>
  ...
  <div class="doc-header">
    ...
    <div class="doc-title-block">
      ...
      <div class="doc-ref"><?= e($invoice['invoice_number']) ?></div>
      <div class="doc-date"><?= formatDate($invoice['date']) ?></div>
    </div>
  </div>

  <!-- Client block (floated right) -->
  <div class="client-block">
    <div class="client-label">Adressé à :</div>
    <div class="client-name"><?= e($invoice['client_name']) ?></div>
    <div class="client-detail">
      <?php if ($invoice['client_address']): ?>
        <?= e(trim(strtok($invoice['client_address'], "\n"))) ?>
        <?php strtok('', ''); ?>
        <br>
      <?php endif; ?>
  ...
  <div class="totals-wrap">
    <table class="totals-table">
      <tr>
        <td>Total HT</td>
        <td><?= formatMoney((float)$invoice['total_ht']) ?></td>
      </tr>
      ...
      <tr class="total-net">
        ...
        <td><?= formatMoney((float)$invoice['total_ttc']) ?></td>
      </tr>
    </table>
  </div>
  ...
  <div class="amount-words">
    <strong>Arrêté à la somme de :</strong> <?= e(amountInWords((float)$invoice['total_ttc'])) ?>
  </div>
  ...
  <div class="info-row">
    <div class="info-item">
      ...
      <div class="ii-value"><?= e(paymentMethodLabel($invoice['payment_method'])) ?></div>
    </div>
  </div>
  <?php endif; ?>
  ...
  <div class="notes-block"><?= nl2br(e($invoice['notes'])) ?></div>
  <?php endif; ?>

  <!-- Signature -->
  <?php
    $docDateParts = $invoice['date'] ? explode('-', $invoice['date']) : null;
